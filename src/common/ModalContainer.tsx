        ...
        <Modal isOpen={isOpen} hideCloseButton size='md' backdrop='blur' className='text-content3-foreground'>
            <ModalContent className='text-center p-6'>
                ...
                <ModalFooter className="flex justify-center gap-4">
                    <Button className="bg-white text-dark border" onClick={onConfirm} fullWidth>{confirmText}</Button>
                    <Button color='primary'className="text-dark" fullWidth onClick={onClose}>{closeText}</Button>
                </ModalFooter>
            </ModalContent>
        </Modal>
    )
