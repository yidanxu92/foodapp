...
const OrdersTable = ({ orders, isAdmin }: OrdersTableProps) => {
  return (
    <Table aria-label="Orders Table" isStriped
      ...
      classNames={{ th: "text-md text-center", td: "text-md text-center text-gray-600", table: 'gap-4' }}>
      <TableHeader>
            ...
            <TableRow key={order._id}>
              <TableCell>
                <p className="whitespace-nowrap">
                  {dayjs(order.createdAt).tz('America/New_York').format('YYYY-MM-DD HH:mm:ss')}
                </p>
              </TableCell>
